...
<div class="container">
  ...
  <div class="container" style="margin-left: -15px">
    ...
    <input type="checkbox" name="" value="callcenter">Lahore<br>
    <input type="checkbox" name="" value="it">Karachi<br>
    <input type="checkbox" name="" value="hr">Faislabad<br>
  <div id="cty1" class="collapse">
   <input type="checkbox" name="" value="art">Islamabad<br>
   <input type="checkbox" name="" value="librarian">Abbottabad<br>
   <input type="checkbox" name="" value="cad">D.I. Khan<br>
  </div>
  <div class="container" style="margin-left: -15px">
...
<ul id="boder" style="margin-left: -60; margin-right: 130; margin-top: 0;">
  ...
  <p>Are you hunting for Accounts, Finance & Financial Services
  Jobs in Pakistan? ROZEE.PK is your premier online destination for all Accounting Jobs currently available across Pakistan. 
  Find and filter jobs as per your preferences and apply online using our simple and easy job application process. 
  Make the right career move with ROZEE.PK!</p>
</ul>
<ul>
<br><br>
<?php
...
$q = "Select email,gender,qualification from postajob";
$res = $con->query($q);
...
<ul id ='boder' style="margin-left: -60; margin-right: 130; margin-top: 0;"><p>A company wants 
this <?php echo $ro['email']?>and have to be this<?php echo $ro['gender'] ?><?php echo $ro['qualification']?></p></ul>
<?php
}?>
</table>
</ul>
