...
$q = "Select jobtitle,jobdescription,skills,qualification from postajob where joblocation ='islamabad'";
$res = $con->query($q);
...
$con = mysqli_connect("$host","$username","");
mysqli_select_db($con,"rozeeroti");
$q = "Select jobtitle,jobdescription,skills,qualification from postajob where organization ='pakistan reading project'";
$res = $con->query($q);
//$res = mysqli_query($q) or die ("Query error<br>". mysqli_error());
?>
<?php
