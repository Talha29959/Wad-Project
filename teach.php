...
<ul id="boder" style="margin-left: -60; margin-right: 130; margin-top: 0;">
<h3>Teachers/Education, Training & Development Jobs in Pakistan</h3>
<p>Are you hunting for Teachers/Education, Training & Development Jobs in Pakistan? ROZEE.PK is your premier online destination for all Teachers/Education, Training & Development Jobs currently available across Pakistan. Find and filter jobs as per your preferences and apply online using our simple and easy job application process. Make the right career move with ROZEE.PK!</p>
</ul>
...
$q = "Select jobtitle,jobdescription,skills,qualification from postajob where jobtitle ='teacher'";
$res = $con->query($q);
