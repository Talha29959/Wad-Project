...
<ul id="boder" style="margin-left: -60; margin-right: 130; margin-top: 0;">
  <h3>Engineering Jobs in Pakistan</h3>
  <p>Rozee is your ultimate online destination for Engineering jobs in Pakistan. Choose from thousands of job listings in the Engineering Industry and make the best career move for you. Whether you are pursuing a career in the private or government sector, you can find the latest Engineering jobs only on ROZEE.PK!</p>
</ul>
...
$q = "Select jobtitle,jobdescription,skills,qualification from postajob where jobtitle ='engineer'";
$res = $con->query($q);
