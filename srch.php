...
$q = "Select firstname,lastname,dateofbirth,gender,nationality from personalinformation where email ='$na'";
...
while ($ro = $res->fetch_assoc()) {?>
 <br>
<ul id ='boder' style="margin-left: -60; margin-right: 130; margin-top: 10;"><p> your first name is  <?php echo $ro['firstname']?> 
 and your last name is  <?php echo $ro['lastname']?>
 and your Date of Birth is  <?php echo $ro['dateofbirth']?>
  and have nationality of  <?php echo $ro['nationality'] ?>  your gender is
<?php echo $ro['gender']?></p></ul>
<?php
}?>
</div>
</div>
