...
$q = "Select jobtitle,jobdescription,skills,qualification,email from postajob where joblocation ='lahore'";
$res = $con->query($q);
...
while ($ro = $res->fetch_assoc()) {?>
 <br>
 <form method="post">
<ul id ='boder' style="margin-left: -60; margin-right: 130; margin-top: 10;"><p> A company wants  <?php echo $ro['jobdescription']?> 
and have these skills <?php echo $ro['skills'] ?> want minimum qualification  <?php $umail =$ro['email']?> <?php echo $ro['email']?></p><input type="text"id ="appl"name="appl" placehlder ="Email"> <input type=
"submit" name = "submit" value ="Apply">
</ul>
<?php
}?>
</form>
...
$q = "insert into jobseekers values ('$unam','$umail')";
$re = mysqli_query($c,$q);
