...
while ($ro = $res->fetch_assoc()) {?>
 <br>
<ul id ='boder' style="margin-left: -60; margin-right: 130; margin-top: 10;"><p> A company wants  <?php echo $ro['salary']?>
 and have these skills <?php echo $ro['skills'] ?> want minimum qualification  
<?php echo $ro['joblocation']?></p></ul>
<?php
}?>
</div>
</div>
