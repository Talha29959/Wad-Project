...
<ul id="boder" style="margin-left: -60; margin-right: 130; margin-top: 0;">
<h3>Health & Medicine Jobs in Pakistan</h3>
<p>Are you hunting for Health & Medicine Jobs in Pakistan? ROZEE.PK is your premier online destination for all Health & Medicine Jobs currently available across Pakistan. Find and filter jobs as per your preferences and apply online using our simple and easy job application process. Make the right career move with ROZEE.PK!</p>
</ul>
<?php
...
$q = "Select jobtitle,jobdescription,skills,qualification from postajob where jobtitle ='health'";
$res = $con->query($q);
