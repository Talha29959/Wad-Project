...
<p>Are you hunting for Administration Jobs in Pakistan? ROZEE.PK is your premier online destination for all Administration Jobs currently available across Pakistan. Find and filter jobs as per your preferences and apply online using our simple and easy job application process. Make the right career move with ROZEE.PK!</p>
</ul>
<?php
...
$q = "Select email,gender,qualification from postajob where jobtitle ='admin'";
$res = $con->query($q);
//$res = mysqli_query($q) or die ("Query error<br>". mysqli_error());
?>
<?php
while ($ro = $res->fetch_assoc()) {?>
<h4> <?php echo $ro['jobtitle']?> </h4> <br>
