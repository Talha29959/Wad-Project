...
<ul id="boder" style="margin-left: -60; margin-right: 130; margin-top: 0;">
<h3>Telemarketing Jobs in Pakistan</h3>
<p>Are you hunting for Telemarketing Jobs in Pakistan? ROZEE.PK is your premier online destination for all Telemarketing Jobs currently available across Pakistan. Find and filter jobs as per your preferences and apply online using our simple and easy job application process. Make the right career move with ROZEE.PK!</p>
</ul>
...
$q = "Select jobtitle,jobdescription,skills,qualification from postajob where jobtitle ='telemarket'";
$res = $con->query($q);
